# Tree Point Cloud QSM Optimization Workflow

## Overview
This repository provides a complete MATLAB workflow, used in conjunction with TreeQSM (https://github.com/InverseTampere/TreeQSM), for processing tree point cloud data and optimizing quantitative structure models (QSMs) using the Individual-tree Adaptive Optimization (IAO) method.
...
### Reference Data
* `referencedata.xlsx` – Reference data for IAO optimization.
